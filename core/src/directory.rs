...
static ALL_AVSES: &[(Chain, NodeType, H160)] = &[
    ...
    (Chain::Mainnet, NodeType::Lagrange, h160!(0x35F4f28A8d3Ff20EEd10e087e8F96Ea2641E6AA2)),
    (Chain::Holesky, NodeType::Lagrange, h160!(0x18A74E66cc90F0B1744Da27E72Df338cEa0A542b)),
    (
        Chain::Mainnet,
        NodeType::LagrangeZKProover,
    ...
    (Chain::Mainnet, NodeType::K3, h160!(0x83742C346E9f305dcA94e20915aB49A483d33f3E)),
    ...
    (Chain::Mainnet, NodeType::AVA, h160!(0x18343Aa10e3D2F3A861e5649627324aEAD987Adf)),
    (Chain::Holesky, NodeType::AVA, h160!(0xEA3E82F9Ae371A6a372A6DCffB1a9bD17e0608eF)),
