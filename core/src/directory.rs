...
static ALL_MAINNET_AVSES: &[(Chain, NodeType, H160)] = &[
    ...
    (Chain::Mainnet, NodeType::DodoChainMach, h160!(0xd50e0931703302b080880c45148f5d83ea66ae2a)),
    (Chain::Mainnet, NodeType::OpenLayerMainnet, h160!(0xf7fcff55d5fdaf2c3bbeb140be5e62a2c7d26db3)),
...
static ALL_HOLESKY_AVSES: &[(Chain, NodeType, H160)] = &[
    ...
    (Chain::Holesky, NodeType::AltlayerMach, h160!(0xae9a4497dee2540daf489beddb0706128a99ec63)),
    (Chain::Holesky, NodeType::XterioMach, h160!(0x648e5012d7b30755963755f7dd7ff03e2f61bf8b)),
    (Chain::Holesky, NodeType::Omni, h160!(0xa7b2e7830c51728832d33421670dbbe30299fd92)),
    ...
    (Chain::Holesky, NodeType::Aethos, h160!(0xde93e0da148e1919bb7f33cd8847f96e45791210)),
    ...
    (
        Chain::Holesky,
        NodeType::ChainbaseNetworkV1,
        h160!(0x5e78eff26480a75e06ccdabe88eb522d4d8e1c9d),
    ),
    (
        Chain::Holesky,
        NodeType::ChainbaseNetworkV2,
        h160!(0x0fb6b02f8482a06cf1d99558576f111abc377932),
    ),
    (Chain::Holesky, NodeType::GoPlusAVS, h160!(0x6e0e0479e177c7f5111682c7025b4412613cd9de)),
    (
        Chain::Holesky,
        NodeType::UngateInfiniRouteBase,
        h160!(0x1b8ad2ab0fa5585804ce9e9e2c6097f0328bb05c),
    ),
    (Chain::Holesky, NodeType::PrimevMevCommit, h160!(0xededb8ed37a43fd399108a44646b85b780d85dd4)),
    (Chain::Holesky, NodeType::AlignedLayer, h160!(0x58f280bebe9b34c9939c3c39e0890c81f163b623)),
    // (
    //     Chain::Holesky,
