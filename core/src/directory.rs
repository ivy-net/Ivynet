...
const ALL_MAINNET_AVSES: [(NodeType, H160); 28] = [
    ...
    (NodeType::UngateInfiniRouteBase, h160!(0xb3e069fd6dda251acbde09eda547e0ab207016ee)),
    (NodeType::UngateInfiniRoutePolygon, h160!(0xf75bc9850f4c44e682537c477c4bb08f71f695da)),
