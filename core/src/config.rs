...
pub struct IvyConfig {
    ...
    pub default_private_ecdsa_keyfile: PathBuf,
    /// Default Operator private key file full path bls
    pub default_private_bls_keyfile: PathBuf,
...
impl Default for IvyConfig {
    fn default() -> Self {
        Self {
            ...
            default_private_ecdsa_keyfile: "".into(), // TODO: Option
            default_private_bls_keyfile: "".into(),
...
impl IvyConfig {
    ...
    pub fn set_private_ecdsa_keyfile(&mut self, keyfile: PathBuf) {
        self.default_private_ecdsa_keyfile = keyfile;
    }
    ...
    pub fn set_private_bls_keyfile(&mut self, keyfile: PathBuf) {
        self.default_private_bls_keyfile = keyfile;
    }
