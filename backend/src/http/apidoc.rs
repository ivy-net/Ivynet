...
#[openapi(
    paths(
        ...
        organization::get_notification_settings,
        organization::set_notification_settings,
        organization::get_alert_flags,
        organization::set_alert_flags,
        client::client,
    ...
    components(
        schemas(
            ...
            organization::TelegramSettings,
            organization::PagerDutySettings,
            db::Role,
            db::AvsVersionData,
            db::Avs,
            db::Machine,
